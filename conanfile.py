...
class VulkanTutorialConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires(
            "spdlog/1.10.0"
        )  # Any version >= 1.9.0 crashes on MacOS (might be fixed by now, see https://github.com/conan-io/conan-center-index/issues/8480)
    ...
    def generate(self):
        ...
        replace_in_file(
            self,
            os.path.join(self.source_folder, "src", "bindings", "imgui_impl_sdl2.cpp"),
            "SDL_GetWindowSize",
